...
def make_parser():
    ...
    parser.add_argument('--trainDataPath', type=str, default='/mnt/c/Users/dhanu/Documents/School/442/Project/PCC_net/data/original/shanghaitech/part_B_final/train_data/images', 
