...
from tool_func.layer import Conv2d, FC, convDU, convLR

from torchvision.ops import RoIPool
import pdb
from tool_func.utils import weights_normal_init, initialize_weights
...
class ori(nn.Module):
    ...
    def __init__(self, bn=False, num_classes=10):
        ...
        self.hl_prior = nn.Sequential(Conv2d( 32, 16, 9, same_padding=True, NL='prelu', bn=bn),
                                     nn.MaxPool2d(2),
                                     Conv2d(16, 32, 7, same_padding=True, NL='prelu', bn=bn),
                                     nn.MaxPool2d(2),
        ...
        # generate dense map
        self.den_stage_1 = nn.Sequential(Conv2d( 32, 32, 7, same_padding=True, NL='prelu', bn=bn),
                                     nn.MaxPool2d(2),
        ...
        self.den_pred = Conv2d(8, 1, 1, same_padding=True, NL='relu', bn=bn)
