...
from tool_func.utils import CrossEntropyLoss2d
...
class TreeCounter(nn.Module):
    def __init__(self, ce_weights=None):
        ...
        self.loss_bce_fn = nn.BCELoss(weight=ce_weights) # binary cross entropy loss
        self.loss_cel_fn = CrossEntropyLoss2d()"""
